...
export class OpportunityOpportunityComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-opportunity-opportunity div table .btn-danger'));
  title = element.all(by.css('jhi-opportunity-opportunity div h2#page-heading span')).first();
...
export class OpportunityOpportunityUpdatePage {
  pageTitle = element(by.id('jhi-opportunity-opportunity-heading'));
...
export class OpportunityOpportunityDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-opportunityOpportunity-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-opportunityOpportunity'));
